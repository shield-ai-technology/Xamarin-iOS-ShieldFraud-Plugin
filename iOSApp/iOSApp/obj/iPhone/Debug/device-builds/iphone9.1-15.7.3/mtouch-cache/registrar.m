...
@implementation DeviceShieldCallback {
}
	...
	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		bool call_super = false;
		id rv = native_to_managed_trampoline_4 (self, _cmd, &managed_method, &call_super, 0x1E08);
		if (call_super && rv) {
...
@implementation iOSApp_CallbackExtension {
	XamarinObject __monoObjectGCHandle;
}
	-(void) release
	{
	...
	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		bool call_super = false;
		id rv = native_to_managed_trampoline_4 (self, _cmd, &managed_method, &call_super, 0x1400);
		if (call_super && rv) {
			struct objc_super super = {  rv, [NSObject class] };
			rv = ((id (*)(objc_super*, SEL)) objc_msgSendSuper) (&super, @selector (init));
		}
...
@implementation __NSObject_Disposer {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_9 (self, _cmd, &managed_method, p0, 0xBF04);
	}
	-(BOOL) conformsToProtocol: (void *) protocol
	{
		GCHandle exception_gchandle;
	...
	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		bool call_super = false;
		id rv = native_to_managed_trampoline_4 (self, _cmd, &managed_method, &call_super, 0xBC04);
		if (call_super && rv) {
			struct objc_super super = {  rv, [NSObject class] };
			rv = ((id (*)(objc_super*, SEL)) objc_msgSendSuper) (&super, @selector (init));
		}
...
@end
	...
	static MTClassMap __xamarin_class_map [] = {
		...
		{ NULL, 0x200 /* #2 'SceneDelegate' => 'NewSingleViewTemplate.SceneDelegate, iOSApp' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x400 /* #3 'AppDelegate' => 'iOSApp.AppDelegate, iOSApp' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x608 /* #4 'DeviceShieldCallback' => 'ShieldFraud.DeviceShieldCallback, ShieldFraud_iOS' */, (MTTypeFlags) (1) /* CustomType */ },
		{ NULL, 0x500 /* #5 'iOSApp_CallbackExtension' => 'iOSApp.CallbackExtension, iOSApp' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x3404 /* #6 'UIViewController' => 'UIKit.UIViewController, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x600 /* #7 'ViewController' => 'iOSApp.ViewController, iOSApp' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		...
		{ NULL, 0xB04 /* #11 '__MonoMac_NSAsyncSynchronizationContextDispatcher' => 'Foundation.NSAsyncSynchronizationContextDispatcher, Xamarin.iOS' */, (MTTypeFlags) (2) /* UserType */ },
		...
		{ NULL, 0x1204 /* #14 'NSError' => 'Foundation.NSError, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x1604 /* #15 'NSNull' => 'Foundation.NSNull, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x1D04 /* #16 'NSRunLoop' => 'Foundation.NSRunLoop, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x1E04 /* #17 'NSSet' => 'Foundation.NSSet, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x2104 /* #18 'NSString' => 'Foundation.NSString, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x2704 /* #19 'NSEnumerator' => 'Foundation.NSEnumerator, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x2804 /* #20 'NSException' => 'Foundation.NSException, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x3104 /* #21 'UIApplication' => 'UIKit.UIApplication, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x3304 /* #22 'UIView' => 'UIKit.UIView, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x3504 /* #23 'UIWindow' => 'UIKit.UIWindow, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x3904 /* #24 'UIScene' => 'UIKit.UIScene, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x3A04 /* #25 'UISceneConfiguration' => 'UIKit.UISceneConfiguration, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x3B04 /* #26 'UISceneConnectionOptions' => 'UIKit.UISceneConnectionOptions, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x3E04 /* #27 'UISceneSession' => 'UIKit.UISceneSession, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0xE04 /* #28 'NSDictionary' => 'Foundation.NSDictionary, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x1B04 /* #29 '__NSObject_Disposer' => 'Foundation.NSObject+NSObject_Disposer, Xamarin.iOS' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x208 /* #30 '_TtC11ShieldFraud13BlockedDialog' => 'ShieldFraud.BlockedDialog, ShieldFraud_iOS' */, (MTTypeFlags) (1) /* CustomType */ },
		{ NULL, 0x308 /* #31 '_TtC11ShieldFraud13Configuration' => 'ShieldFraud.Configuration, ShieldFraud_iOS' */, (MTTypeFlags) (1) /* CustomType */ },
		{ NULL, 0x908 /* #32 '_TtC11ShieldFraud6Shield' => 'ShieldFraud.Shield, ShieldFraud_iOS' */, (MTTypeFlags) (1) /* CustomType */ },
		{ NULL, 0 },
	};

	static const MTManagedClassMap __xamarin_skipped_map [] = {
		{ 0x1004, 0xE04 /* 'Foundation.NSDictionary`2' => 'Foundation.NSDictionary' */ },
		{ 0x2004, 0x1E04 /* 'Foundation.NSSet`1' => 'Foundation.NSSet' */ },
	};

	static const MTAssembly __xamarin_registration_assemblies [] = {
		{ "iOSApp", "5c473e0c-7e7f-4742-98e8-c8f2068cd76c" }, 
		...
		{ "ShieldFraud_iOS", "350221a8-506f-4c0d-bbe0-85c3cc5cc9f4" }
	};

	static const MTProtocolWrapperMap __xamarin_protocol_wrapper_map [] = {
		{ 0x408 /* ShieldFraud.IDeviceResultStateDelegate */, 0x508 /* DeviceResultStateDelegateWrapper */ },
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [4].handle = [DeviceShieldCallback class];
	__xamarin_class_map [5].handle = [iOSApp_CallbackExtension class];
	__xamarin_class_map [6].handle = objc_getClass ("UIViewController");
	__xamarin_class_map [7].handle = [ViewController class];
	...
	__xamarin_class_map [30].handle = [_TtC11ShieldFraud13BlockedDialog class];
	__xamarin_class_map [31].handle = [_TtC11ShieldFraud13Configuration class];
	__xamarin_class_map [32].handle = [_TtC11ShieldFraud6Shield class];
